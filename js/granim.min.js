...
})(
  {
      ...
      function (t, e, i) {
        ...
        function s(t) {
          this.getElement(t.element),
            ...
            (this.customDirection = t.customDirection || {}),
            ...
            this.eventPolyfill(),
            (this.scrollDebounceThreshold = t.scrollDebounceThreshold || 300),
            (this.scrollDebounceTimeout = null),
            (this.isImgLoaded = !1),
            (this.isCanvasInWindowView = !1),
            (this.firstScrollInit = !0),
            (this.animating = !1),
            (this.gradientLength = this.states[
              this.activeState
            ].gradients[0].length),
            t.image &&
              t.image.source &&
            ...
            (this.pauseWhenNotInViewNameSpace = this.pauseWhenNotInView.bind(
              this
            )),
            (this.setSizeAttributesNameSpace = this.setSizeAttributes.bind(
              this
            )),
            this.onResize(),
        ...
        (s.prototype.animateColors = t("./animateColors.js")),
          (s.prototype.changeBlendingMode = t("./changeBlendingMode.js")),
          (s.prototype.changeDirection = t("./changeDirection.js")),
          (s.prototype.changeState = t("./changeState.js")),
          (s.prototype.clear = t("./clear.js")),
          (s.prototype.convertColorToRgba = t("./convertColorToRgba.js")),
          (s.prototype.destroy = t("./destroy.js")),
          (s.prototype.eventPolyfill = t("./eventPolyfill.js")),
          (s.prototype.getColor = t("./getColor.js")),
          (s.prototype.getColorDiff = t("./getColorDiff.js")),
          (s.prototype.getColorPos = t("./getColorPos.js")),
          (s.prototype.getColorPosDiff = t("./getColorPosDiff.js")),
          (s.prototype.getCurrentColors = t("./getCurrentColors.js")),
          (s.prototype.getCurrentColorsPos = t("./getCurrentColorsPos.js")),
          (s.prototype.getDimensions = t("./getDimensions.js")),
          (s.prototype.getElement = t("./getElement.js")),
          (s.prototype.getLightness = t("./getLightness.js")),
          (s.prototype.makeGradient = t("./makeGradient.js")),
          (s.prototype.onResize = t("./onResize.js")),
          (s.prototype.onScroll = t("./onScroll.js")),
          (s.prototype.pause = t("./pause.js")),
          (s.prototype.pauseWhenNotInView = t("./pauseWhenNotInView.js")),
          (s.prototype.play = t("./play.js")),
          (s.prototype.prepareImage = t("./prepareImage.js")),
          (s.prototype.refreshColorsAndPos = t("./refreshColorsAndPos.js")),
          (s.prototype.setColors = t("./setColors.js")),
          (s.prototype.setDirection = t("./setDirection.js")),
          (s.prototype.setSizeAttributes = t("./setSizeAttributes.js")),
          (s.prototype.triggerError = t("./triggerError.js")),
          (s.prototype.validateInput = t("./validateInput.js")),
          (e.exports = s);
      },
      {
        "./animateColors.js": 2,
      ...
      function (t, e, i) {
        ...
        e.exports = function (t) {
          ...
          (null === this.previousTimeStamp || o) &&
            ...
            (this.previousTimeStamp = t),
            this.refreshColorsAndPos(e),
            e < 100
              ? (this.animation = requestAnimationFrame(
                  this.animateColors.bind(this)
                ))
              : this.channelsIndex <
                  this.states[this.activeState].gradients.length - 2 || n
      ...
      function (t, e, i) {
        ...
        e.exports = function (t) {
          ...
          this.activeState !== t &&
            ...
            this.states[t].gradients[0].forEach(function (t, i, s) {
    ...
    7: [
      function (t, e, i) {
        ...
        function o(t) {
          ...
          return i
            ? [parseInt(i[1], 16), parseInt(i[2], 16), parseInt(i[3], 16), 1]
            : null;
        }
        function n(t, e, i) {
          return (
        ...
        function r(t, e, i, s) {
          ...
          return (
            0 === e
              ? (o = r = a = i)
              : ((h = i < 0.5 ? i * (1 + e) : i + e - i * e),
                (c = 2 * i - h),
                (o = n(c, h, t + 1 / 3)),
                (r = n(c, h, t)),
                (a = n(c, h, t - 1 / 3))),
            [Math.round(255 * o), Math.round(255 * r), Math.round(255 * a), s]
          );
        }
        var a,
          h = {
      ...
      function (t, e, i) {
        ...
        e.exports = function (t, e) {
          return "object" == typeof t && t.pos
            ? t.pos
            : parseFloat(
                e ? ((1 / (this.gradientLength - 1)) * e).toFixed(2) : 0
              );
        };
      },
      {},
    ...
    17: [
      function (t, e, i) {
        ...
        e.exports = function (t) {
          ...
          if (!this.canvas)
            throw new Error("`" + t + "` could not be found in the DOM");
        };
      },
      {},
    ],
      ...
      function (t, e, i) {
        ...
        e.exports = function () {
          ...
          for (e = 0; e < o.length; e++)
            (s = null === s ? o[e] : s + o[e]),
              e === o.length - 1 && (t = Math.round(s / (e + 1)));
        ...
        e.exports = function () {
          ...
          this.name &&
            ("light" === this.getLightness()
              ? (e.remove(this.name + "-dark"), e.add(this.name + "-light"))
              : (e.remove(this.name + "-light"), e.add(this.name + "-dark"))),
    ...
    20: [
      function (t, e, i) {
        "use strict";
        e.exports = function (t) {
          return "removeListeners" === t
            ? void window.removeEventListener(
                "resize",
                this.setSizeAttributesNameSpace
              )
            ...
            function t(t) {
              ...
              switch (n) {
                case "center":
                  (i = o > s ? -(o - s) / 2 : (s - o) / 2),
                    (e.imagePosition[t] = i),
                    (e.imagePosition["x" === t ? "width" : "height"] = o);
                  break;
                case "top":
              ...
              if (e.image.stretchMode)
                switch (
                  (n =
                    "x" === t ? e.image.stretchMode[0] : e.image.stretchMode[1])
                ) {
                  case "none":
                    break;
                  case "stretch":
                    (e.imagePosition[t] = 0),
                      (e.imagePosition["x" === t ? "width" : "height"] = s);
                    break;
            ...
            this.imageNode
              ...
              : ((this.imageNode = new Image()),
                ...
                (this.imageNode.onload = function () {
                  (e.imgOriginalWidth = e.imageNode.width),
                    (e.imgOriginalHeight = e.imageNode.height),
                    t(),
                    e.refreshColorsAndPos(),
                    (e.isPausedWhenNotInView && !e.isCanvasInWindowView) ||
                      (e.animation = requestAnimationFrame(
                        e.animateColors.bind(e)
                      )),
                    (e.isImgLoaded = !0);
                }),
          ...
          for (s = 0; s < this.activeColors.length; s++) {
            for (o = 0; o < 4; o++)
              (e =
                n.activeColors[s][o] +
                (3 !== o
                  ? Math.ceil((n.activeColorsDiff[s][o] / 100) * t)
                  : Math.round((n.activeColorsDiff[s][o] / 100) * t * 100) /
                    100)),
                e <= 255 && e >= 0 && (n.currentColors[s][o] = e);
            (i = parseFloat(
              (
                n.activeColorsPos[s] +
                (n.activeColorsPosDiff[s] / 100) * t
              ).toFixed(4)
            )),
              i <= 1 && i >= 0 && (n.currentColorsPos[s] = i);
          }
          this.makeGradient();
        };
      },
          ...
          return (
            ...
            void 0 !== this.channels[this.activeState][this.channelsIndex]
              ? ((this.activeColors = this.channels[this.activeState][
                ...
                (this.activeColorsDiff = this.channels[this.activeState][
                  this.channelsIndex
                ].colorsDiff),
                (this.activeColorsPos = this.channels[this.activeState][
                  this.channelsIndex
                ].colorsPos),
                void (this.activeColorsPosDiff = this.channels[
                  this.activeState
                ][this.channelsIndex].colorsPosDiff))
              : (this.channels[this.activeState].push([{}]),
                ...
                this.states[this.activeState].gradients[
                  ...
                  c[o.channelsIndex].colors.push(h),
                    o.activeColors.push(h),
                    c[o.channelsIndex].colorsPos.push(a),
                    o.activeColorsPos.push(a),
                    o.isCurrentColorsSet ||
                      (o.currentColors.push(o.convertColorToRgba(n)),
                      o.currentColorsPos.push(a)),
                    o.channelsIndex ===
                    o.states[o.activeState].gradients.length - 1
                      ? ((t = o.getColorDiff(
                          c[o.channelsIndex].colors[r],
                          c[0].colors[r]
                        )),
                        (e = o.getColorPosDiff(
                          c[o.channelsIndex].colorsPos[r],
                          c[0].colorsPos[r]
                        )))
                      : ((i = o.convertColorToRgba(
                          o.getColor(
                            o.states[o.activeState].gradients[
                              o.channelsIndex + 1
                            ][r]
                          )
                        )),
                        ...
                        (t = o.getColorDiff(c[o.channelsIndex].colors[r], i)),
                        (e = o.getColorPosDiff(
                          c[o.channelsIndex].colorsPos[r],
                          s
                        ))),
                    c[o.channelsIndex].colorsDiff.push(t),
                    o.activeColorsDiff.push(t),
                    c[o.channelsIndex].colorsPosDiff.push(e),
                    o.activeColorsPosDiff.push(e);
                }),
                (this.activetransitionSpeed =
                  this.states[this.activeState].transitionSpeed || 5e3),
      ...
      function (t, e, i) {
        ...
        e.exports = function () {
          ...
          switch (this.direction) {
            ...
            case "custom":
              return t.createLinearGradient(
                s(this.customDirection.x0, this.x1),
                s(this.customDirection.y0, this.y1),
                s(this.customDirection.x1, this.x1),
                s(this.customDirection.y1, this.y1)
              );
          }
        };
      },
      ...
      function (t, e, i) {
        ...
        function s(t) {
          for (var e, i = !0, s = 0; i && s < t.length; ) {
            if (((e = t[s]), "string" != typeof e)) i = !1;
            else {
              var o = null,
                n = null;
              e.indexOf("px") !== -1 && (n = "px"),
                e.indexOf("%") !== -1 && (n = "%"),
                (o = e.split(n).filter(function (t) {
                  return t.length > 0;
                })),
                (!n ||
                  o.length > 2 ||
          ...
          switch (t) {
            case "image":
              (Array.isArray(this.image.position) &&
                ...
                e.indexOf(this.image.position[0]) !== -1 &&
                i.indexOf(this.image.position[1]) !== -1) ||
                this.triggerError("image.position"),
                this.image.stretchMode &&
                  ((Array.isArray(this.image.stretchMode) &&
                    2 === this.image.stretchMode.length &&
                    o.indexOf(this.image.stretchMode[0]) !== -1 &&
                    o.indexOf(this.image.stretchMode[1]) !== -1) ||
                    this.triggerError("image.stretchMode"));
              break;
            case "blendingMode":
              n.indexOf(this.image.blendingMode) === -1 &&
                (this.clear(), this.triggerError("blendingMode"));
              break;
            case "direction":
              r.indexOf(this.direction) === -1
